...
public sealed class DependencyDirectionTests
{
    ...
    [InlineData("NSchema.Project", new[] { "NSchema.Deployment", "NSchema.Diff", "NSchema.Plan", "NSchema.Apply", "NSchema.Operations", "NSchema.Plugins" })]
    // Current may read the shared vocabulary (Project.Domain.Models) but never the project language or policies.
    [InlineData("NSchema.Deployment", new[] { "NSchema.Project.Nsql", "NSchema.Project.Policies", "NSchema.Diff", "NSchema.Plan", "NSchema.Apply", "NSchema.Operations", "NSchema.Plugins" })]
