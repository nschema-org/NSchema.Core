...
- `Destroy` operation. Destroys all managed objects in the target database. Triggered via `app.Destroy()` or `RunOperation(MigrationOperation.Destroy)`. Use with extreme caution.
