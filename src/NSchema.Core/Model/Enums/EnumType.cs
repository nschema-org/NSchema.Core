...
public sealed class EnumType(SqlIdentifier name, List<string>? values = null) : DatabaseObject(name), IEquatable<EnumType>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public override EnumType Clone() => new(Name, [.. Values]) { Comment = Comment };
