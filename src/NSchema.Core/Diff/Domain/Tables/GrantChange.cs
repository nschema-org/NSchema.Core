...
/// </summary>
/// <param name="Change"><see cref="ChangeKind.Add"/> for a grant, <see cref="ChangeKind.Remove"/> for a revocation.</param>
...
public sealed record GrantChange(ChangeKind Change, SqlIdentifier Role, TablePrivilege? Privileges = null);
