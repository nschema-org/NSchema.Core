...
internal static class PluginSettingsDiagnostics
{
    ...
    public static Diagnostic UnassignableValue(string? value, string key) =>
        Diagnostic.Error(Source, $"Value '{value}' cannot be assigned to '{key}'.");
}
